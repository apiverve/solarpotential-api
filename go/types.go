// Package solarpotential provides a Go client for the Solar Potential API.
//
// For more information, visit: https://apiverve.com/marketplace/solarpotential?utm_source=go&utm_medium=readme
package solarpotential
...
// Request contains the parameters for the Solar Potential API.
//
// Parameters:
...
// ResponseData contains the data returned by the Solar Potential API.
type ResponseData struct {
	Coordinates CoordinatesData `json:"coordinates"`
	UsableHours UsableHoursData `json:"usableHours"`
...
// UsableHoursData represents the usableHours object.
type UsableHoursData struct {
	AvgDailyUsableSunlightHours float64 `json:"avgDailyUsableSunlightHours"`
	YearlyUsableSunlightHoursRaw int `json:"yearlyUsableSunlightHoursRaw"`
	AdjustedYearlyUsableSunlightHours int `json:"adjustedYearlyUsableSunlightHours"`
}
